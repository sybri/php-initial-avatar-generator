...
class InitialAvatar
{
    ...
    {
        $this->parameter_bgColor =  $background;
    ...
    {
        $this->parameter_fontColor = $color;
    ...
    {
        $this->parameter_cacheTime =  $minutes;
    ...
    {
        $this->parameter_rounded = $rounded;
